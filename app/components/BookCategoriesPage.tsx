...
const BookCategoriesPage = () => {
  ...
  return (
    <>
      ...
      <section className="relative mt-0 mb-12 sm:mb-16 lg:mb-20 py-8 sm:py-12 lg:py-16 overflow-hidden">
        {/* Background Video */}
        ...
        {/* Books Page Layout - Categories on right, books on left */}
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            {/* Books Display - Left Side */}
            <div className="lg:col-span-2">
              ...
              >
                ...
                <div className="text-center lg:text-left mb-8 sm:mb-12">
                  ...
                  <div className="w-24 h-1 bg-[#ffbe02] mx-auto lg:mx-0 rounded-full"></div>
                </div>
                  ...
                  {categories
                    ...
                    ?.books.map((book, bookIndex) => (
                      ...
                      >
                        ...
                        <div className="absolute inset-0 -mx-1 -my-2 bg-white/10 rounded-2xl border border-white/30 shadow-lg z-10 group-hover:scale-95 transition-transform duration-300 ease-out">
                  ...
                  <div className="space-y-8 pl-8">
                    {categories.map((category, index) => (
                      <motion.button
                        ...
                        className={`relative flex items-center transition-all duration-300 group py-2 ${
                        ...
                        whileTap={{ scale: 0.98 }}
                      >
                        <span className="font-['Poppins'] font-semibold text-sm sm:text-base tracking-wide">
                          {category.name.replace("\n", " ")}
                        </span>
                        {/* Active category highlight - vertically centered */}
                        <div className={`absolute -left-8 top-1/2 w-0.5 h-6 transform -translate-y-1/2 transition-all duration-300 ${
                          activeCategory === category.name 
                            ? 'bg-[#ffbe02]' 
